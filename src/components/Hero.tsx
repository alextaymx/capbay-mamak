...
export function Hero() {
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32 min-h-[82vh]">
      ...
      <div className="mt-10 flex justify-center space-x-6">
        ...
        <ButtonLink href="https://www.youtube.com/watch?v=fzcoNq93dO0" variant="outline">
          <svg
            aria-hidden="true"
      ...
      <div className="mt-36 lg:mt-44">
        <p className="font-display text-base text-slate-900">
          Unit 13A01, Level 13A, Tropicana Gardens Office Tower, No. 2A, Persiaran Surian, Tropicana
          Indah, 47810 Petaling Jaya, Selangor Darul Ehsan
        </p>
