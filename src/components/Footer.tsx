        ...
        <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
          <div className="flex space-x-6">
            <Link href="https://alextaymx.netlify.app">
              <a target="_blank" rel="noopener noreferrer" className="group l -mt-1">
                <span className="sr-only">Contact Author</span>
            ...
            <Link href="https://github.com/alextaymx/capbay-mamak#readme">
              <a className="group" target="_blank" rel="noopener noreferrer">
                <span className="sr-only">CapBay Mamak on GitHub</span>
                <svg
                  aria-hidden="true"
                  className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700"
                >
          ...
          <p className="mt-6 text-sm text-slate-500 sm:mt-0">
            Made with ❤️ by Alex &copy; {new Date().getFullYear()}.
          </p>
        </div>
      </Container>
    </footer>
